...
# Generate the files
python3 generate.py --version 2.{0,1,2,3,4,5,6,7} 3.{0,1,2,3,4,5}

# Create index.html files from the template
python3 template.py --version 2.{0,1,2,3,4,5,6,7} 3.{0,1,2,3,4,5}

# Make output directory, don't fail if it exists
mkdir -p build

# Copy to output directory
cp -R {2.{0,1,2,3,4,5,6,7},3.{0,1,2,3,4,5},all.html,index.html,results.json,style.css,wheel.css} build

# Remove templated index.html files
rm {2.{0,1,2,3,4,5,6,7},3.{0,1,2,3,4,5}}/index.html
